...
(() => {
  ...
  // ----------------------- Araç çizimi --------------------------
  // Araç çizimi artık carrender.js içindeki profesyonel modüle devredilir.
  // (Hem tarayıcı hem Node'da test edilebilir, render düzeneğiyle iterasyon yapıldı.)
  function drawCarSprite(cx, baseY, width, body, accent, brake) {
    UcarCar.drawProCar(ctx, cx, baseY, width, { body: body, brake: brake });
  }
